...
class UseEmployee {
    public static void main(String args[]) {
      ...
      List<Employee> hrlist5 =emp.stream()
        ...
        Double hrlist6 =emp.stream()
        					.map(Employee::getSalary)
        					.reduce(0.0,Double::sum);
        System.out.println(hrlist6);
        
        //printing all depts
       List<String> hrlist7 =emp.stream()
        						  .map(Employee::getDepartment)
        						  .distinct()
        						  .collect(Collectors.toList());
        hrlist7.forEach(System.out::println);
        //top 3 employee print
       List<Employee> hrlist8 =emp.stream()
								  .limit(3)
								  .collect(Collectors.toList());
        hrlist8.forEach(System.out::println);
        
        //display top 3 salaries
        List<Employee> hrlist9 =emp.stream()
				        			.sorted((ref2,ref1)->Double.compare(ref1.getSalary(), ref2.getSalary()))
				        			.limit(3)
				        			.collect(Collectors.toList());
        hrlist9.forEach(System.out::println);
        
        //skip first 2 records and display
       List<Employee> hrlist10 =emp.stream()
					    			.skip(2)
					    			.collect(Collectors.toList());
        hrlist10.forEach(System.out::println);
